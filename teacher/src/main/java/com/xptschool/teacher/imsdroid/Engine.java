...
//    private IScreenService mScreenService;
    ...
    private void showNotification(int notifId, int drawableId, String tickerText) {
        ...
        Intent intent = new Intent(XPTApplication.getContext(), MainActivity.class);
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(XPTApplication.getContext(), notifId/*requestCode*/, intent, PendingIntent.FLAG_UPDATE_CURRENT);
