...
public class BubbleImageView extends ImageView {
    ...
    private void updateShaderMatrix() {
        ...
        Log.i(TAG, "mBitmap: " + mBitmapWidth + "  " + mBitmapHeight);
        Log.i(TAG, "mDrawableRect: " + mDrawableRect.width() + " " + mDrawableRect.height());
    ...
    private void rightPath(RectF rect, Path path) {
        ...
        Log.i(TAG, "rightPath: height " + (rect.bottom - rect.top));
