...
package com.android.widget.swipebacklayout;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.android.widget.swipebacklayout.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.android.widget.swipebacklayout.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.android.widget.swipebacklayout.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.android.widget.swipebacklayout.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
