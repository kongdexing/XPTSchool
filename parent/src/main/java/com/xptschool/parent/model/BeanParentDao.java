...
public class BeanParentDao extends AbstractDao<BeanParent, Void> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Parent_name = new Property(1, String.class, "parent_name", false, "PARENT_NAME");
        public final static Property Parent_phone = new Property(2, String.class, "parent_phone", false, "PARENT_PHONE");
        public final static Property Relation = new Property(3, String.class, "relation", false, "RELATION");
        ...
        public final static Property Work_unit = new Property(7, String.class, "work_unit", false, "WORK_UNIT");
        public final static Property Family_tel = new Property(8, String.class, "family_tel", false, "FAMILY_TEL");
        public final static Property Email = new Property(9, String.class, "email", false, "EMAIL");
        public final static Property Api_id = new Property(10, String.class, "api_id", false, "API_ID");
        public final static Property Security_key = new Property(11, String.class, "security_key", false, "SECURITY_KEY");
    };
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BEAN_PARENT\" (" + //
                "\"SP_ID\" TEXT," + // 0: sp_id
                "\"PARENT_NAME\" TEXT," + // 1: parent_name
                "\"PARENT_PHONE\" TEXT," + // 2: parent_phone
                "\"RELATION\" TEXT," + // 3: relation
                "\"SEX\" TEXT," + // 4: sex
                "\"U_ID\" TEXT," + // 5: u_id
                "\"ADDRESS\" TEXT," + // 6: address
                "\"WORK_UNIT\" TEXT," + // 7: work_unit
                "\"FAMILY_TEL\" TEXT," + // 8: family_tel
                "\"EMAIL\" TEXT," + // 9: email
                "\"API_ID\" TEXT," + // 10: api_id
                "\"SECURITY_KEY\" TEXT);"); // 11: security_key
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, BeanParent entity) {
        ...
        if (work_unit != null) {
            stmt.bindString(8, work_unit);
        }
 
        String family_tel = entity.getFamily_tel();
        if (family_tel != null) {
            stmt.bindString(9, family_tel);
        }
        ...
        if (api_id != null) {
            stmt.bindString(11, api_id);
        }
 
        String security_key = entity.getSecurity_key();
        if (security_key != null) {
            stmt.bindString(12, security_key);
        }
    }
    ...
    public BeanParent readEntity(Cursor cursor, int offset) {
        BeanParent entity = new BeanParent( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // parent_name
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // parent_phone
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // relation
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // work_unit
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // family_tel
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), // email
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // api_id
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11) // security_key
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, BeanParent entity, int offset) {
        ...
        entity.setParent_name(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setParent_phone(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setRelation(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        ...
        entity.setWork_unit(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setFamily_tel(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
        entity.setEmail(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
        entity.setApi_id(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setSecurity_key(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
     }
